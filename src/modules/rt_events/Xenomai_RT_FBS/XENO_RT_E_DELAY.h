...
#ifndef _XENO_RT_E_DELAY_H_
#define _XENO_RT_E_DELAY_H_
...
class FORTE_XENO_RT_E_DELAY: public CEventSourceFB{
  DECLARE_FIRMWARE_FB(FORTE_XENO_RT_E_DELAY)
...
public:
  FORTE_XENO_RT_E_DELAY(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);

  virtual ~FORTE_XENO_RT_E_DELAY(){};
