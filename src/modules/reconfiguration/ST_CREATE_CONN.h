 ...
 ***
 *** Name: ST_CREATE_CONN
 *** Description: Creates an event or a data connection between two FB instances
 *** Version: 
 ***     1.0: 2014-05-05/Gerhard Ebenhofer, Matthias Plasch - 4DIAC-Consortium - null
 *************************************************************************/

#ifndef _ST_CREATE_CONN_H_
...
class FORTE_ST_CREATE_CONN: public CFunctionBlock{
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_ST_CREATE_CONN), m_poDevice(pa_poSrcRes->getDevice()){
  };

  virtual ~FORTE_ST_CREATE_CONN(){};
