...
const CStringDictionary::TStringId GEN_OR::scm_anDataOutputNames[] = {
		g_nStringIdOUT };

const CStringDictionary::TStringId GEN_OR::scm_anDataOutputTypeIds[] = {
		g_nStringIdANY_BIT };

const TForteInt16 GEN_OR::scm_anEIWithIndexes[] = { 0 };
const CStringDictionary::TStringId GEN_OR::scm_anEventInputNames[] = {
		g_nStringIdREQ };

const TDataIOID GEN_OR::scm_anEOWith[] = { 0, 255 };
const TForteInt16 GEN_OR::scm_anEOWithIndexes[] = { 0, -1 };
const CStringDictionary::TStringId GEN_OR::scm_anEventOutputNames[] = {
		g_nStringIdCNF };

GEN_OR::GEN_OR(const CStringDictionary::TStringId pa_nInstanceNameId,
...
void GEN_OR::executeEvent(int pa_nEIID) {
	switch (pa_nEIID) {
...
bool GEN_OR::configureFB(const char *pa_acConfigString) {
	bool bRetVal = false;
